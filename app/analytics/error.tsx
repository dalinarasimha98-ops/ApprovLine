      ...
      <section className="rounded-3xl border border-al-warning/30 bg-al-warning/10 p-6 text-al-warning shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            type="button"
            onClick={reset}
            className="inline-flex min-h-0 h-11 items-center justify-center rounded-xl bg-al-accent px-5 text-sm font-bold text-white shadow-sm"
          >
            Retry
          </button>
          <PendingLink href="/analytics?demo=1" pendingText="Loading demo..." className="inline-flex min-h-0 h-11 items-center justify-center rounded-xl border border-al-warning/30 bg-al-surface px-5 text-sm font-bold text-al-warning shadow-sm">
            Open demo preview
          </PendingLink>
        </div>
      </section>
