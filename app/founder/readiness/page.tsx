    ...
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-emerald-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-emerald-700">Launch Certification</p>
            <h3 className="mt-2 text-2xl font-black text-slate-950">Security, tenant isolation, reliability, and infrastructure checklist</h3>
            <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-slate-600">
              The Certification Center evaluates real, live-checked controls — Security, Tenant Isolation, Reliability, System Infrastructure, Integrations, Observability, and AI configuration — plus documented backup and load-target policy. There is no numeric certification score; every control shows its own honest Verified / Attention / Not Verified / Failed / Not Assessed status.
            </p>
          </div>
          <Link href="/founder/certification" className="rounded-xl bg-emerald-600 px-5 py-3 text-center text-sm font-black text-white hover:bg-emerald-700">
