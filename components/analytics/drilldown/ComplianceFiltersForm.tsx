...
export function ComplianceFiltersForm({
  values,
  filterOptions,
}: {
  values: FilterValues;
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    params.set('page', '1');
    router.push(`/analytics/drilldown/compliance-readiness?${params.toString()}`);
  }

  function handleClear() {
    router.push('/analytics/drilldown/compliance-readiness');
  }
