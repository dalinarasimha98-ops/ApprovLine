...
export function ManualApprovalPanel({ approval, detail, evidence, versions, confirmations, canManage, currentUserId, currentUserRole }: {
  ...
  if (editing) return <section className="rounded-2xl border border-blue-200 bg-al-surface p-6 shadow-sm"><ManualApprovalForm approvalId={approval.id} initial={initial} onCancel={() => setEditing(false)} /></section>;

  return (
    <section className="grid gap-5 rounded-3xl border border-blue-200 bg-al-surface p-6 shadow-sm" aria-labelledby="manual-approval-heading">
