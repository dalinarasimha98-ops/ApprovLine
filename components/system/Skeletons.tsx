...
export function TableSkeleton() {
  return (
    <section className="grid gap-6">
      <CardSkeleton rows={1} />
      <div className="rounded-2xl border border-al-border bg-white p-4 shadow-sm">
...
export function OnboardingSkeleton() {
  return (
    <main className="min-h-screen bg-[#f5f7fb] px-4 py-10">
      <div className="mx-auto max-w-2xl rounded-[24px] border border-al-border bg-white p-8 shadow-[0_24px_80px_rgba(15,23,42,0.12)]">
