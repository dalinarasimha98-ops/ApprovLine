...
export function ToastOnQuery() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 max-w-sm rounded-2xl border border-al-border bg-white px-4 py-3 text-sm font-bold text-al-text shadow-[0_20px_70px_rgba(15,23,42,0.18)]">
